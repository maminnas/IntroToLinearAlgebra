...
public class VectorStuff2 : MonoBehaviour {
    ...
    public GameObject MovingPoint, MovingPoint2, MovingPoint3, MovingPoint4;
    ...
    void Start () {
        ...
        for (int i = 0; i < size; i++)//lines.Length
        {
            ...
            newLine[i].material = mat4;
        }
        
        newLine[0].material = mat5;
        newLine[2].material = mat4;
        newLine[3].material = mat6;
        ...
        newLine[1].SetPosition(1, MovingPoint2.transform.position);
        newLine[2].SetPosition(1, MovingPoint3.transform.position);
        newLine[3].SetPosition(1, MovingPoint3.transform.position);
	...
	void Update () {
        newLine[2].SetPosition(0, MovingPoint4.transform.position);
        newLine[2].SetPosition(1, MovingPoint3.transform.position);
        newLine[3].SetPosition(1, MovingPoint3.transform.position);
